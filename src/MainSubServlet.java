...
//            parameters.put("")
            ...
            JasperExportManager.getInstance(context).exportReportToHtmlFile(jasperPrint, this.getServletContext().getRealPath("/")+"mainsub.html");
            conn.close();

            response.sendRedirect("mainsub.html");
        }catch (Exception e) {
